...
- [x] `gcovr` [✅](https://aur.archlinux.org/packages/gcovr/)
- [x] `python-dbusmock` [✅](https://aur.archlinux.org/packages/python-dbusmock/)
...
- [x] `apparmor-libapparmor` [✅](https://aur.archlinux.org/packages/apparmor-libapparmor/)
